function FoodOrderIcon(props) {
    return (
        <svg
            ...
            style={{
                enableBackground: "new 0 0 122.88 116.65",
            }}
            xmlSpace="preserve"
            {...props}
        >
