...
function ChooseFood({ className }) {
    return (
        <svg
            ...
            className={className}
        >
            <path fill="#3f3d56" d="M250.367 723.942H769.924V726.183H250.367z"></path>
            <path
                fill="#a0616a"
            ...
            ></path>
            <path fill="#e6e6e6" d="M58.445 110.234H304.445V321.234H58.445z"></path>
            <circle cx="131.445" cy="347.234" r="18" fill="#ef4444"></circle>
            <path
                fill="#fff"
            ...
            ></path>
            <circle cx="226.445" cy="347.234" r="18" fill="#ef4444"></circle>
            <path
                fill="#fff"
            ...
            ></path>
            <circle cx="131.445" cy="644.234" r="18" fill="#ef4444"></circle>
            <path
                fill="#fff"
            ...
            ></path>
            <circle cx="226.445" cy="644.234" r="18" fill="#ef4444"></circle>
            <path
                fill="#fff"
